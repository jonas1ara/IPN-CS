...
int main()
{
    libro JT, CR; // Se define una estructura de tipo libro llamada JT con 10 elementos

    // libro JT[10]; // Se define una estructura de tipo libro llamada JT con 10 elementos
