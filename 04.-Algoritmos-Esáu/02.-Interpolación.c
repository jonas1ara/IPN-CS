/*
	...
	Description: This program calculates quadratic interpolation
	based on three points on a plane
*/
...
float x, y, x0= 2014, y0=3000, x1=2018, y1=3800, x2= 2019,
y2=4100;
...
y=(y0*(((x-x1)*(x-x2))/((x0-x1)*(x0-x2))))+(y1*(((x-x0)*(x-x2))/((x1-x0)*(x1-x2))))+(y2*(((x-x0)*(x-x1))/((x2-x0)*(x2-
x1))));
//Prints result
