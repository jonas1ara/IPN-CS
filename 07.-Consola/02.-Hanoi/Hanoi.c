...
*/
 ...
 if(col<=5) Sleep(.8); else if(col<=10) Sleep(.3); else if(col<=15) Sleep(0.06); else if(col>15) Sleep(0.02);
 }
 else
 {
 ...
 system("cls");
 mueveDisco( tab, fil, col, ultNum, O, D );
 if(col<=5) Sleep(0.8); else if(col<=10) Sleep(0.3); else if(col<=15) Sleep(0.06); else if(col>15) Sleep(0.02);
